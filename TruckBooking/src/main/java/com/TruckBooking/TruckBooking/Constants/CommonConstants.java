package com.TruckBooking.TruckBooking.Constants;
...
public class CommonConstants {
	...
	public static String loadingCityError = "Enter loading city";
	public static String unloadingCityError = "Enter unloading city";
	...
	public static String weightError = "Enter weight";
	public static String dateError = "Enter date";
	public static String idError = "Enter id";
	public static String updateSuccess = "Updated Succcessfully";
